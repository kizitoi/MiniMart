...
<div class="container">
    ...
    <form action="<?= isset($doc) ? site_url('system_documentation/update/'.$doc['id']) : site_url('system_documentation/store') ?>" method="post" enctype="multipart/form-data">
        <div class="mb-3">
            <label>Title</label>
        ...
        <a href="<?= site_url('system_documentation') ?>" class="btn btn-secondary">Back</a>
    </form>
</div>
