      ...
      <div style="max-height: 80vh; overflow-y: auto; padding-right: 5px;">
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column">
            ...
            <?php if (!empty($header_links)): ?>
              <?php foreach ($header_links as $link): ?>
                <?php if ($link['isbutton'] == '1'): ?>
                      ...
                      &&  $link['link'] != 'bulksms'
                      &&  $link['link'] != 'company'
                      &&  $link['link'] != 'departments'
                      && $link['link'] != 'permissions'
                      && $link['link'] != 'mpesa_transactions'
                      && $link['link'] != 'mpesa_settings'
                      && $link['link'] != 'numbering_settings'
                      && $link['link'] != 'unit_of_measure'
                      && $link['link'] != 'admin/system_documentation'
                      && $link['link'] != 'roles'
                                  && $link['link'] != 'payment_descriptions'
                                              && $link['link'] != 'payment_descriptions'
                              && $link['link'] != 'shops'
                                      && $link['link'] != 'suppliers'
                                              && $link['link'] != 'vat_settings'
                      &&  $link['link'] != 'role_permissions'): ?>
                  ...
                  <li class="nav-item mb-2">
                    <a href="<?= site_url($link['link']) ?>" class="btn btn-block text-left btn-primary">
            ...
            <li class="nav-item mb-2">
  <a href="<?= site_url('system_documentation/view') ?>" class="btn btn-block btn-custom-blue text-left">
...
<?= view('partials/reminders_footer') ?>
</body>
</html>
